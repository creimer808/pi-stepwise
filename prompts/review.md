...
**Do not make code changes in this phase — only document.** Follow the review skill exactly. End by telling the user to either turn the findings into a new plan with `/kickoff` or call it done.
