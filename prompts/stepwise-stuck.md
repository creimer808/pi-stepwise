...
Load and follow the **stepwise-stuck** skill.
...
Do not theorize about the cause before you have a single command, already run, that goes red on this exact bug. Follow the stuck skill exactly. When resolved, tell the user to run `/stepwise-build` to continue.
